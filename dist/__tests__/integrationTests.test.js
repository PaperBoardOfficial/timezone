...
describe("Integration Tests", () => {
    describe("Email Extraction Pipeline", () => {
        ...
        test("should convert times in the extracted data to user timezone", () => {
            ...
            const convertedData = (0, timezone_conversion_service_1.convertExtractedTimesToUserTimezone)(mockExtractedData, userTimezone);
        ...
        test("should process email data and generate correct candidate slots", () => {
            const userTimezone = "Europe/Kyiv";
            const processedData = (0, timezone_conversion_service_1.processEmailAnalysisWithTimezones)(mockExtractedData, userTimezone);
    ...
    describe("Bug Fix Verification: 9 AM ET to 4 PM EEST", () => {
        ...
        test("should convert 9 AM ET to 4 PM EEST (not 5 PM)", () => {
            const userTimezone = "Europe/Kyiv";
            const bugFixResult = (0, timezone_conversion_service_1.processEmailAnalysisWithTimezones)(bugTestData, userTimezone);
            // Check that we have candidate slots
            ...
            const localTimeHour = (0, moment_timezone_1.default)(slot.startLocal).format("HH");
            ...
            const hourDifference = moment_timezone_1.default.tz(slot.startLocal, "Europe/Kyiv").hour() -
                moment_timezone_1.default.tz(slot.startSource, "America/New_York").hour();
    ...
    describe("Additional Timezone Combinations", () => {
        test("should convert Pacific Time (PT) to Japan Standard Time (JST)", () => {
            ...
            const result = (0, timezone_conversion_service_1.processEmailAnalysisWithTimezones)(ptToJstData, "Asia/Tokyo");
            ...
            const localTimeHour = (0, moment_timezone_1.default)(slot.startLocal).hour();
        ...
        test("should convert Central European Time (CET) to Indian Standard Time (IST)", () => {
            ...
            const result = (0, timezone_conversion_service_1.processEmailAnalysisWithTimezones)(cetToIstData, "Asia/Kolkata");
            expect(result.candidateSlots.length).toBeGreaterThan(0);
            const slot = result.candidateSlots[0];
            // Check time conversion from CET to IST (+3.5/4.5 hours)
            const localTimeHours = (0, moment_timezone_1.default)(slot.startLocal).format("HH:mm");
