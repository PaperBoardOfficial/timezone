...
exports.preserveSourceTimezone = preserveSourceTimezone;
exports.preserveSourceTimezoneNull = preserveSourceTimezoneNull;
/**
 ...
 */
function preserveSourceTimezone(extractedData) {
    if (!extractedData || !extractedData.dates)
    ...
    result.dates = result.dates.map((dateInfo) => {
        if (dateInfo.times) {
            dateInfo.times = dateInfo.times.map((timeSlot) => {
                return {
                    ...timeSlot,
 ...
 */
function preserveSourceTimezoneNull(value) {
